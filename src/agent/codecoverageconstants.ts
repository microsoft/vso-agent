...
export var jacocoMavenSingleModuleEnable = "";
export var jacocoMavenMultiModuleEnable = "";

// Enable Cobertura Code Coverage for Maven builds using this props
export var coberturaMavenSingleModuleEnable = "";
export var coberturaMavenMultiModuleEnable = "";

export var coberturaGradleBuildScript = `buildscript {
    repositories {
        mavenCentral()
    }
    dependencies {
